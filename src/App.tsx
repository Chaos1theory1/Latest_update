          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
            ...
            <div className="max-w-3xl mx-auto text-center space-y-4">
              ...
              <h1 className="font-display text-4xl font-bold tracking-tight text-stone-900 leading-tight">
                <EditableText
                  value={getLocalizedValue(siteContent.about, "title", currentLanguage, "About us")}
                  onSave={(val) => handleUpdateTextSection("about", { 
                    ...siteContent.about, 
                    title: val,
              ...
              <p className="text-stone-500 text-lg leading-relaxed font-light">
                <EditableText
                  value={getLocalizedValue(siteContent.about, "subtitle", currentLanguage, "Dynamic mycelial propagation and bio-material design")}
                  onSave={(val) => handleUpdateTextSection("about", { 
                    ...siteContent.about, 
                    subtitle: val,
                    ...
                    <div className="bg-white border border-stone-200 rounded-2xl p-6 shadow-xs space-y-8">
                      ...
                      >
                        <div className="flex justify-between items-center bg-stone-50 p-3 rounded-lg border border-stone-200">
                          <h4 className="text-xs font-bold text-stone-700 uppercase tracking-wider font-mono h-fit">Corporate Footer & Contacts</h4>
                          <span className="text-[10px] bg-emerald-100 text-emerald-800 px-2 py-0.5 rounded font-mono font-bold uppercase">
                            Editing Language: {currentLanguage.toUpperCase()}
                          </span>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-start">
                          <div className="space-y-1">
                            <label className="text-xs font-semibold text-stone-700">Footer Brand Mission / Description ({currentLanguage.toUpperCase()}) *</label>
                            <textarea
                              rows={2}
                              value={editFooter?.[`description_${currentLanguage}`] || editFooter?.description || ""}
                          ...
                          <div className="space-y-1">
                            <label className="text-xs font-semibold text-stone-700">Footer Legal Copyright / Registration ({currentLanguage.toUpperCase()}) *</label>
                            <textarea
                              rows={2}
                              value={editFooter?.[`copyright_${currentLanguage}`] || editFooter?.copyright || ""}
                              onChange={(e) => setEditFooter({ 
                                ...editFooter, 
                                copyright: e.target.value,
                                [`copyright_${currentLanguage}`]: e.target.value 
                              })}
                              className="w-full bg-[#fcfcf9] border border-stone-200 rounded-xl px-3 py-2 text-xs text-stone-900 focus:outline-hidden focus:border-emerald-700 transition-all font-light"
                          ...
                          <div className="space-y-1">
                            <label className="text-xs font-semibold text-stone-700">Laboratory ID / Code ({currentLanguage.toUpperCase()})</label>
                            <input
                              type="text"
                              value={editFooter?.[`labId_${currentLanguage}`] || editFooter?.labId || ""}
                              onChange={(e) => setEditFooter({ 
                                ...editFooter, 
                                labId: e.target.value,
                                [`labId_${currentLanguage}`]: e.target.value 
                              })}
                              className="w-full bg-[#fcfcf9] border border-stone-200 rounded-xl px-3 py-2 text-xs text-stone-900 focus:outline-hidden focus:border-emerald-700 transition-all font-light"
                          ...
                          <div className="space-y-1">
                            <label className="text-xs font-semibold text-stone-700">Regional Operations List Heading ({currentLanguage.toUpperCase()})</label>
                            <input
                              type="text"
                              value={editFooter?.[`regionalTitle_${currentLanguage}`] || editFooter?.regionalTitle || ""}
                              onChange={(e) => setEditFooter({ 
                                ...editFooter, 
                                regionalTitle: e.target.value,
                                [`regionalTitle_${currentLanguage}`]: e.target.value 
                              })}
                              className="w-full bg-[#fcfcf9] border border-stone-200 rounded-xl px-3 py-2 text-xs text-stone-900 focus:outline-hidden focus:border-emerald-700 transition-all font-light"
                          ...
                          <div className="space-y-1">
                            <label className="text-xs font-semibold text-stone-700">Contact Office Group Heading ({currentLanguage.toUpperCase()})</label>
                            <input
                              type="text"
                              value={editFooter?.[`contactHeader_${currentLanguage}`] || editFooter?.contactHeader || ""}
                              onChange={(e) => setEditFooter({ 
                                ...editFooter, 
                                contactHeader: e.target.value,
                                [`contactHeader_${currentLanguage}`]: e.target.value 
                              })}
                              className="w-full bg-[#fcfcf9] border border-stone-200 rounded-xl px-3 py-2 text-xs text-stone-900 focus:outline-hidden focus:border-emerald-700 transition-all font-light"
                          ...
                          <div className="space-y-1">
                            <label className="text-xs font-semibold text-stone-700">Privacy Policy Link Label ({currentLanguage.toUpperCase()})</label>
                            <input
                              type="text"
                              value={editFooter?.[`privacyText_${currentLanguage}`] || editFooter?.privacyText || ""}
                              onChange={(e) => setEditFooter({ 
                                ...editFooter, 
                                privacyText: e.target.value,
                                [`privacyText_${currentLanguage}`]: e.target.value 
                              })}
                              className="w-full bg-[#fcfcf9] border border-stone-200 rounded-xl px-3 py-2 text-xs text-stone-900 focus:outline-hidden focus:border-emerald-700 transition-all font-light"
                          ...
                          <div className="space-y-1">
                            <label className="text-xs font-semibold text-stone-700">Technical Spec Link Label ({currentLanguage.toUpperCase()})</label>
                            <input
                              type="text"
                              value={editFooter?.[`termsText_${currentLanguage}`] || editFooter?.termsText || ""}
                              onChange={(e) => setEditFooter({ 
                                ...editFooter, 
                                termsText: e.target.value,
                                [`termsText_${currentLanguage}`]: e.target.value 
                              })}
                              className="w-full bg-[#fcfcf9] border border-stone-200 rounded-xl px-3 py-2 text-xs text-stone-900 focus:outline-hidden focus:border-emerald-700 transition-all font-light"
                        ...
                        <div className="border-t border-stone-150 pt-4 text-start">
                          <h5 className="text-xs font-bold text-stone-700 uppercase tracking-wider font-mono mb-3 animate-fade-in">Office Contact Details</h5>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1">
                              <label className="text-xs font-semibold text-stone-700 block col-span-1">Contact Email Address</label>
                              <input
                                type="email"
                            ...
                            <div className="space-y-1">
                              <label className="text-xs font-semibold text-stone-700 block col-span-1">Contact Telephone</label>
                              <input
                                type="text"
                                value={editContactDetails?.phone || ""}
                                onChange={(e) => setEditContactDetails({ ...editContactDetails, phone: e.target.value })}
                                className="w-full bg-[#fcfcf9] border border-stone-200 rounded-xl px-3 py-2 text-xs text-stone-900 focus:outline-hidden focus:border-emerald-700 transition-all font-light"
                                placeholder="e.g. +216 94 038 433"
                              />
                            </div>
                            <div className="space-y-1 col-span-1 md:col-span-2">
                              <label className="text-xs font-semibold text-stone-700 block">Physical Registered Address</label>
                              <input
                                type="text"
                                value={editContactDetails?.address || ""}
                                onChange={(e) => setEditContactDetails({ ...editContactDetails, address: e.target.value })}
                                className="w-full bg-[#fcfcf9] border border-stone-200 rounded-xl px-3 py-2 text-xs text-stone-900 focus:outline-hidden focus:border-emerald-700 transition-all font-light"
                        ...
                        <div className="border-t border-stone-150 pt-4 text-start space-y-3">
                          <div className="flex justify-between items-center">
                            <h5 className="text-xs font-bold text-stone-700 uppercase tracking-wider font-mono">
                              Regional Operations ({currentLanguage.toUpperCase()})
                            </h5>
                            <button
                              type="button"
                              onClick={() => {
                                const regionsKey = `regions_${currentLanguage}`;
